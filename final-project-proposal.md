...
The COVID-19 pandemic profoundly disrupted commuting and lifestyle
patterns. Many people avoided enclosed public transit and turned to
private or semi-private options. As an open-air, flexible system, Citi
Bike offers a valuable lens to observe these shifts.

# Introduction

This study uses Citi Bike data (<https://citibikenyc.com/system-data> )
from 2019–2020 to compare user behavior before and during the pandemic.
By analyzing patterns across age and gender, we reveal demographic
differences and insights for urban planning.
